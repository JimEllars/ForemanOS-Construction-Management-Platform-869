  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-secondary-800 p-8 rounded-lg text-center border-2 border-dashed border-secondary-300 dark:border-secondary-700">
        <SafeIcon icon={FiFileText} className="w-16 h-16 mx-auto text-secondary-400 mb-4" />
        <h3 className="text-lg font-medium text-secondary-900 dark:text-secondary-100 mb-2">
          Quote Management Coming Soon
        </h3>
        <p className="text-secondary-600 dark:text-secondary-400">
          This is where you will be able to create, view, send, and manage all your quotes.
        </p>
      </div>
    </div>
  );
